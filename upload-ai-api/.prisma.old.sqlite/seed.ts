...
'''`.trim()
  ...
  await prisma.prompt.create({
    data: {
      title: 'Relacionados YouTube',
      template: `Seu papel é gerar uma lista de 3 vídeos relacionados a um vídeo do YouTube.
...
Além disso, no final da lista inclua uma lista de 3 até 10 hashtags em letra minúscula contendo palavras-chave do vídeo.
